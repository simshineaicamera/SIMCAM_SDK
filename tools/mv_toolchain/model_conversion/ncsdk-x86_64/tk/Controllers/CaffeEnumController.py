...
def isDepthwiseDeconvolution(layer, output_channels, input_channels):
    return layer.type in ["Deconvolution"] and \
        layer.convolution_param.group > 1 and \
        layer.convolution_param.group == input_channels and \
        output_channels % input_channels == 0
...
def get_caffe_op_type(layer, input_channels=1, output_channels=1):
    ...
    if isDepthwiseDeconvolution(layer, output_channels, input_channels):
        return StageType.depthwise_deconvolution
